...
### n8n ဆိုတာဘာလဲ?
n8n (Nodemation လို့အသံထွက်ပါတယ်) ဆိုတာက workflow automation tool တစ်ခုပါပဲ။ သူ့ရဲ့ အဓိက concept က **"If This Happens, Then Do That"** ပါပဲ။ ဒါပေမဲ့ Zapier တို့ထက် ပိုပြီး powerful ဖြစ်သလို၊ developer-friendly လည်းဖြစ်တယ်။ သူ့ရဲ့ အမိုက်ဆုံး feature က **self-host** လုပ်လို့ရတာပဲ။ ဆိုလိုတာက သူ့ကို ကိုယ့်ရဲ့ server (ဒါမှမဟုတ် ကိုယ့်စက်) မှာတင်ပြီး လွတ်လွတ်လပ်လပ် သုံးလို့ရပါတယ်။
...
1.  **Price & Limits:** Zapier တို့က free plan မှာ task အကြိမ်ရေ (runs) နဲ့ multi-step workflow တွေကို ကန့်သတ်ထားတယ်။ နည်းနည်းလေး complex ဖြစ်တဲ့ workflow ဆိုတာနဲ့ paid plan ကို သွားရတော့တာပဲ။ IFTTT ကတော့ ရိုးရှင်းတဲ့ applet တွေအတွက်ကောင်းပေမဲ့ business logic တွေအတွက် သိပ်အဆင်မပြေဘူး။ n8n ကို ကိုယ်တိုင် host ထားရင်တော့ ကိုယ့် server run နိုင်သလောက် သုံးလို့ရတယ်။ limit မရှိဘူး။
